...
public class DbContactos extends DbHelper{
    ...
    public long insertarContacto(String nombre, String apellido, String telefono, String fecha, String hora){
        long id = 0;
        try {
    ...
    public boolean editarContacto(int id,String nombre, String apellido, String telefono, String fecha, String hora){
        boolean correcto = false;

        DbHelper dbHelper = new DbHelper(context);
        SQLiteDatabase db = dbHelper.getWritableDatabase();
        try {
            db.execSQL("UPDATE " + TABLE_CONTACTOS + " SET nombre = '" + nombre + "', apellido = '" + apellido + "', telefono = '" + telefono + "', fecha = '" + fecha + "',hora = '" + hora + "' WHERE id= '" + id +"' ");
            correcto = true;
        }catch (Exception ex){
            ex.toString();
            correcto = false;
